...
=====================
A loose coupling approach is employed for the aero-elastic co-simulation in QBlade. :numref:`fig-aeroelastic_flowchart` shows the flowchart for one complete aeroelastic time step:
...
.. [#f1]   These forces remain constant during the structural sub time steps.
